...
<div align="center">
  <img src="screenshots/dev-0.0.1/Apple%20Silicon-Prompt-Grasp-PerfPowMon.png" alt="效能監控" width="800" style="border-radius: 10px; border: 1.2px solid rgba(0, 212, 255, 0.3); box-shadow: 0 0 15px rgba(0, 212, 255, 0.15);">
  <br><br>
...
3. **資安專家**: 透過專為網宇安全領域微調的 **Foundation-Sec-8B**，進行深度的系統與資安日誌分析。具備**企業級簡潔化 (Conciseness)** 邏輯，能提供結構化、精煉且具備行動建議的技術分析。
...
- **生態系健康檢查**: 執行 `python health_check.py` 以驗證整個 Docker/ML 生態系（Qdrant, InfluxDB, Grafana, Langfuse, Phoenix）的運行狀態。
