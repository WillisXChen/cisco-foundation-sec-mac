...
<div align="center">
  <img src="screenshots/dev-0.0.1/Apple%20Silicon-Prompt-Grasp-PerfPowMon.png" alt="प्रदर्शन मॉनिटर" width="800" style="border-radius: 10px; border: 1.2px solid rgba(0, 212, 255, 0.3); box-shadow: 0 0 15px rgba(0, 212, 255, 0.15);">
  <br><br>
...
3. **सुरक्षा विशेषज्ञ**: **Foundation-Sec-8B** के माध्यम से गहन सिस्टम और सुरक्षा लॉग विश्लेषण करता है, जो विशेष रूप से साइबर सुरक्षा डोमेन के लिए तैयार किया गया है। इसमें संरचित, संक्षिप्त और कार्रवाई योग्य तकनीकी सलाह के लिए **एंटरप्राइज-ग्रेड संक्षिप्तता (Conciseness)** तर्क शामिल है।
...
├── locales/                    # बहुभाषी अनुवाद फ़ाइलें (.po/.mo)
...
├── langfuse_db_storage/        # Langfuse ट्रेसिंग डेटा के लिए स्थानीय स्टोरेज
├── public/                     # कस्टम ब्रांडिंग एसेट्स (लोगो, CSS, थीम)
├── main.py                     # मुख्य Chainlit एप्लिकेशन प्रविष्टि बिंदु
├── api.py                      # GraphQL और कस्टम API एंडपॉइंट्स
├── streamlit_app.py            # ASITOP HUD मॉनिटरिंग इंटरफेस
├── health_check.py             # सिस्टम-व्यापी पारिस्थितिकी तंत्र स्वास्थ्य जांच उपयोगिता
...
-   **Arize Phoenix**: RAG प्रतिक्रियाओं का स्वचालित मूल्यांकन और अनुरेखण।
-   **ASITOP HUD**: GPU/CPU/RAM निगरानी के लिए वास्तविक समय HUD।
-   **Grafana**: ऐतिहासिक प्रदर्शन डैशबोर्ड।
-   **सिस्टम हेल्थ चेक**: पूरे Docker/ML इकोसिस्टम (Qdrant, InfluxDB, Grafana, Langfuse, Phoenix) की स्थिति को सत्यापित करने के लिए `python health_check.py` निष्पादित करें।
